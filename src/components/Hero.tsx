...
function TypingText() {
  ...
  const [fullText, setFullText] = useState(TITLES[0])
...
function ProfileAvatar() {
  return (
    <div className="relative flex items-center justify-center">
      ...
      {/* Avatar circle */}
      <div className="relative w-52 h-52 sm:w-64 sm:h-64 rounded-full overflow-hidden border-4 border-white dark:border-gray-800 shadow-2xl shadow-violet-500/20 flex items-center justify-center bg-gradient-to-br from-violet-400 via-indigo-500 to-purple-600">
      ...
      <motion.div
        ...
        className="absolute -top-2 -right-4 bg-white dark:bg-gray-800 rounded-xl px-3 py-1.5 shadow-lg border border-gray-100 dark:border-gray-700 flex items-center gap-2"
      >
      ...
      <motion.div
        ...
        className="absolute -bottom-2 -left-4 bg-white dark:bg-gray-800 rounded-xl px-3 py-1.5 shadow-lg border border-gray-100 dark:border-gray-700 flex items-center gap-2"
      >
        <span className="text-xl">🚀</span>
        <div>
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <motion.div
          ...
          className="absolute top-1/4 left-1/4 w-72 h-72 bg-violet-300/20 dark:bg-violet-600/10 rounded-full blur-3xl"
        />
        <motion.div
          animate={{ x: [0, -40, 0], y: [0, 30, 0] }}
          transition={{ duration: 10, repeat: Infinity, ease: 'easeInOut', delay: 2 }}
          className="absolute bottom-1/3 right-1/4 w-96 h-96 bg-indigo-300/20 dark:bg-indigo-600/10 rounded-full blur-3xl"
        />
        <motion.div
          animate={{ scale: [1, 1.2, 1] }}
          transition={{ duration: 6, repeat: Infinity, ease: 'easeInOut', delay: 1 }}
          className="absolute top-1/2 right-1/3 w-48 h-48 bg-cyan-300/15 dark:bg-cyan-600/10 rounded-full blur-2xl"
        />
      </div>
          ...
          >
            ...
            >
              ...
              <motion.a
                ...
                className="flex items-center gap-2 px-6 py-3 rounded-xl bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 text-gray-800 dark:text-white font-semibold shadow-sm hover:shadow-md transition-all duration-200 cursor-pointer"
              >
              ...
              <div className="flex gap-3">
                {SOCIAL_LINKS.map(social => (
                  <motion.a
                    ...
                    whileTap={{ scale: 0.9 }}
                    className="w-10 h-10 rounded-xl bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 flex items-center justify-center text-gray-600 dark:text-gray-400 hover:text-violet-600 dark:hover:text-violet-400 hover:border-violet-300 dark:hover:border-violet-600 shadow-sm hover:shadow-md transition-all duration-200"
                  >
